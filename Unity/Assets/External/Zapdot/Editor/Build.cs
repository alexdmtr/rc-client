...
public class Build : MonoBehaviour
{
    ...
    private static string[] scenes = new string[] { 
                                                    ...
                                                    "Assets/MapScene.unity",
                                                    "Assets/DuelScene.unity" 
                                                  };
    ...
    [MenuItem("Tools/Build to Windows", false)]
    protected static void BuildWindows()
    {
        AppInfo.IncrementBuildNumber();
    ...
    [MenuItem("Tools/Push to Dropbox", false)]
    protected static void PushWindowsToDropbox()
    {
        PushToDropbox(StoreType.None);
