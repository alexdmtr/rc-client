...
namespace UnityThreading
{
	public static class TaskExtension
	{
        ...
        /// <param name="action">The action to perform.</param>
        /// <returns>This task.</returns>
		public static Task<T> WhenSucceeded<T>(this Task<T> task, System.Action action)
		{
		...
		{
			System.Action<Task<T>> perform = t =>
			{
				if (target == null)
					action(t);
				else
        ...
        /// <param name="action">The action to perform.</param>
        /// <returns>This task.</returns>
		public static Task WhenSucceeded(this Task task, System.Action action)
		{
        ...
        /// <param name="action">The action to perform.</param>
        /// <returns>This task.</returns>
		public static Task<T> WhenFailed<T>(this Task<T> task, System.Action action)
		{
        ...
        /// <param name="action">The action to perform.</param>
        /// <returns>This task.</returns>
		public static Task WhenFailed(this Task task, System.Action action)
		{
        ...
        /// <param name="action">The action to perform.</param>
        /// <returns>This task.</returns>
		public static Task<T> WhenEnded<T>(this Task<T> task, System.Action action)
		{
		...
		public static IEnumerable<Task> ContinueWhenAnyEnded(this IEnumerable<Task> tasks, System.Action action)
		{
        ...
        /// <param name="action">The action to start.</param>
        /// <returns>This Enumerable of Tasks.</returns>
		public static IEnumerable<Task> ContinueWhenAllEnded(this IEnumerable<Task> tasks, System.Action action)
		{
